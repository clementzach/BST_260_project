...
This model corrects classified players in the testing set as being injured or not injured during a given season 63.7% of the time. The sensitivity of 0.637 indicates that among players who were actually injured, the model predicted 63.7% of them to be injured. The specificity of 0.638 indicates that among players who were not injured, the model corrected classified 63.8% of them as not injured. This model has the most balanced sensitivity and specificity, meaning that the model is equally good at classifying injured and non-injured people.
...
We see that the logistic regression model has the highest accuracy, but the random forest has almost the same accuracy.\
