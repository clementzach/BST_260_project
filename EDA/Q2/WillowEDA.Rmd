...
```{r}
injuries <- read.csv("injuries_only.csv")
```
...
Total injuries for each injury, categorized by body part
```{r}
# Head
...
We see that injuries towards the bottom are not that frequent. Let's group the injuries together based on where they are in the body and look at a more general distriubtion instead.
