...
```{r}
year_games <- injuries %>%
  distinct(year, games_in_season, team)
...
- work with Addison
- talk about Poisson with Dan
- adjust for games per year, not # of players (unless Zach gives just regular season!)
- use other file with only injured people for Willow's thing
