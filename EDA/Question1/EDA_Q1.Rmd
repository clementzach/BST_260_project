...
```{r}
injuries = read.csv("../../EDA/Question1/injury_dat.q1.csv")
players = read.csv("../../EDA/Question1/players_dat.q1.csv")
```
...
exp_injuries_byYear <- players %>% 
  ...
  summarise(avg_total_injuries = sum(total_injuries)/n(),
            ...
            Q3 = quantile(total_injuries, probs = 0.75)) # trying to divide by number of players to get avg. for each player
